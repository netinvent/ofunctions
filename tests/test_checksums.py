...
def test_sha256sum():
    ...
    assert sum == '4c77f1bd193cac476cea5af2225e8c0177d5a009390aa6e119c211a00cf325c9', 'Bogus checksum'
    remove_file(test_file)


def test_check_file_hash():
    test_file = create_test_file()
    result = check_file_hash(test_file, '4c77f1bd193cac476cea5af2225e8c0177d5a009390aa6e119c211a00cf325c9')
...
def test_create_sha256sum_file():
    ...
    with open(sum_file, 'r') as fp:
        data = fp.read()
        assert '{}  {}'.format('4c77f1bd193cac476cea5af2225e8c0177d5a009390aa6e119c211a00cf325c9', filename)\
...
def test_create_manifest_from_dir():
    ...
    with open(manifest_file, 'r') as fp:
        data = fp.read()
        print('{}  {}'.format('4c77f1bd193cac476cea5af2225e8c0177d5a009390aa6e119c211a00cf325c9', test_file))
        print(data)
        assert '{}  {}'.format('4c77f1bd193cac476cea5af2225e8c0177d5a009390aa6e119c211a00cf325c9', test_file) \
               in data, 'sha256file does not contain my favorite file'
