...
def test_bisect():
    ...
    try:
        ...
        assert False, 'bisection left to right without result should produce a ValueError'
    ...
    try:
        ...
        assert False, 'bisection right to left without result should produce a ValueError'
    ...
    print('Bisect result = {}'.format(result))
    assert result == 1388, 'bisection with only valid results should return most right result'
